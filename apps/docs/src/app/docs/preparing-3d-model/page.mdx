...
The [Standard Face 3D Model](/new_3d/reference/standard_face.glb) helps align your 3D models to the user’s face.
...
<ModelViewer modelPath="/new_3d/reference/standard_face.glb" />
...
- Download [Standard Face 3D Model](/new_3d/reference/standard_face.glb)
...
In our case we imported [Original Glasses Model](/new_3d/original/glasses.glb).
And after alignment we got [Aligned Glasses Model](/new_3d/transformed/glasses.glb).
...
1. Model File: [Aligned Glasses Model](/new_3d/transformed/glasses.glb)

   <ModelViewer modelPath="/new_3d/transformed/glasses.glb" />

2. Occluder File: [Ear Occluder](/new_3d/reference/ear_occluder.glb)
   <ModelViewer modelPath="/new_3d/reference/ear_occluder.glb" />
